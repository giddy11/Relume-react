...
const Header = () => {
  ...
  return (
    <header className="border-green h-16 shadow-md bg-white fixed w-full z-40">
      <div className="h-full container mx-auto flex items-center px-4 justify-between">
        ...
        <div className="border-red hidden lg:flex items-center w-full justify-between max-w-sm border rounded-full focus-within:shadow pl-2">
          <input
            type="text"
                ...
                <nav>
                  {user?.role === ROLE.ADMIN && (
                    <Link
                      ...
                      className='whitespace-nowrap hidden md:block hover:bg-slate-100 p-0'
                      onClick={() => setMenuDisplay((prev) => !prev)}
                    >
                      Admin Panel
                    </Link>
